...
import { ppdb, testimoni, gambarhomepage, programs, principle } from "@/components/localDatabase";
                    ...
                    <div className='grid grid-rows-2 gap-2 motion-preset-blur-left-md motion-duration-[2s] motion-ease-in-out'>
                        ...
                        <div className='flex gap-2'>
                            {gambarhomepage.map((gambar, index) => (
                                <img key={index} src={gambar.image} alt="ppdb" className='w-full aspect-video object-cover rounded-xl' />
                            ))}
                        </div>
                    </div>
                </div>
